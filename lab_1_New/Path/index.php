...
$app->get('/fib/{fib}', function (Request $request, Response $response, array $args){
    $fib = (int)$args['fib'];
...
$app->get('/region/{region}', function (Request $request, Response $response, array $args){
